import { JsonController, Post, Get, Body, Param, QueryParams, Res, Put, Delete, NotFoundError, UseBefore } from 'routing-controllers';
...
export default class ChapterController {
    ...
    async getChapterTopPerformerOfTheMonth(
        ...
        try {
            ...
            const getTopPerformer = async (model: mongoose.Model<any>, matchField: string, groupField: string) => {
                const results = await model.aggregate([
                    ...
                    { $unwind: '$memberDetails' },
                    {
                        $project: {
                            ...
                            categoryRepresented: '$memberDetails.personalDetails.categoryRepresented',
            ...
            console.error(`Error fetching top performers for chapter ${chapterId}:`, error);
            return res.status(500).json({
                success: false,
